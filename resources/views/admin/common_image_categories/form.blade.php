...
@section('content')
    ...
    <div class="flex-1 p-6 overflow-auto bg-gray-50">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
            <form method="POST"
                action="{{ isset($model_data) ? route('admin.common-image-categories.edit', $id) : route('admin.common-image-categories.add') }}"
                class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <textarea name="brief"
                                ...
                                placeholder="Short brief about the page">{{ old('brief', $brief) }}</textarea>
