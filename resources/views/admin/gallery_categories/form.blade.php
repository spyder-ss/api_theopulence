...
@section('content')
    @php
        ...
        $sort_order = $model_data->sort_order ?? 0;
    ...
    <div class="flex-1 p-6 overflow-auto bg-gray-50">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
            <form method="POST"
                action="{{ isset($model_data) ? route('admin.gallery-categories.edit', $id) : route('admin.gallery-categories.add') }}"
                class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <select id="parent_id" name="parent_id"
                                ...
                                @foreach($gallery_categories as $category)
                                    <option value="{{ $category->id }}" {{ old('parent_id', $parent_id) == $category->id ? 'selected' : '' }}>
                                        {{ $category->name ?? '' }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" id="sort_order" name="sort_order"
                                value="{{ old('sort_order', $sort_order) }}"
                        ...
                        <div>
                            ...
                            <select id="status" name="status"
                                ...
                                <option value="1" {{ old('status', $status) == '1' ? 'selected' : '' }}>
                                    Active</option>
                                <option value="0" {{ old('status', $status) == '0' ? 'selected' : '' }}>
                                    Inactive</option>
                            </select>
